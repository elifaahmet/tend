...
import { DynamicNotificationProps } from '@tend/lego/product-ui-kit';
...
>`
  ...
  margin-inline-start: ${(props) =>
    calculateWithUnit(props.marginLeft, 'rem', props.theme)};
  margin-inline-end: ${(props) =>
    calculateWithUnit(props.marginRight, 'rem', props.theme)};
